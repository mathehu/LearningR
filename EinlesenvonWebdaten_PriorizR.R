...
PTKlinikenD = readLines('https://klinikradar.de/psychotherapie/kliniken/#klinikliste', warn=FALSE) #Psychotheerapiekliniken Deutschland
#PTRKlinikenD = readLines('https://klinikradar.de/psychiatrie/kliniken/')   #Psychiatriekliniken Deutschland
PTKlinikenD


##Firmennamen
grep("result-list recommended", firmenNUe)
BV_name <- '<h1 class="fn org" itemprop="name">([^<]*)</h1>'
...
##Verkn?pfen der Namens- und Adressenvektoren
